...
LDLIBSOPTIONS=-L/home/pi/lib -lwiringPi -lutility

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/automoto
...
${OBJECTDIR}/SoftwarePWM.o: SoftwarePWM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_OS_LINUX_ -I/home/pi/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SoftwarePWM.o SoftwarePWM.cpp
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG -D_OS_LINUX_ -I/home/pi/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/automoto
